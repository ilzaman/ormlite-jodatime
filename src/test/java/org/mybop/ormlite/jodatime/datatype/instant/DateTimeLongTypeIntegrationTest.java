...
public class DateTimeLongTypeIntegrationTest {
    ...
    public void setUp() throws Exception {
        ...
        DataPersisterManager.registerDataPersisters(DateTimeLongType.getSingleton());
    ...
    public void generation() throws Exception {
        ...
        assertThat(entity.getVersion()).isInstanceOf(DateTime.class);
        assertThat(entity.getVersion()).isEqualByComparingTo(DateTime.now());
    }
    ...
    public void update() throws Exception {
        ...
        final DateTime creation = entity.getVersion();
