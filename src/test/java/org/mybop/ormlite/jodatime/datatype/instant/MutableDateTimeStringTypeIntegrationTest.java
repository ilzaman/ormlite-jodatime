...
public class MutableDateTimeStringTypeIntegrationTest {
    ...
    static final class Entity {
        ...
        private MutableDateTime version;

        public Integer getId() {
            return id;
        }

        public MutableDateTime getVersion() {
            return version;
        }
    ...
    public void setUp() throws Exception {
        ...
        DataPersisterManager.registerDataPersisters(MutableDateTimeStringType.getSingleton());
    ...
    public void generation() throws Exception {
        ...
        assertThat(entity.getVersion()).isInstanceOf(MutableDateTime.class);
        assertThat(entity.getVersion()).isEqualByComparingTo(MutableDateTime.now());
    }
    ...
    public void update() throws Exception {
        ...
        final MutableDateTime creation = entity.getVersion();
